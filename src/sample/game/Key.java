...
public class Key extends Item{
    ...
    public Key(String name, String description, boolean isVisible, boolean isCarry, boolean startWith) {
    ...
    public Key(String name, String description, boolean isVisible, boolean isCarry, boolean startWith, ArrayList<Item> comp) {
        super(name, description, isVisible, isCarry, startWith);
    ...
    public Key(Long id, String name, String description, boolean isVisible, boolean isCarry, boolean startWith, ArrayList<Item> comp) {
